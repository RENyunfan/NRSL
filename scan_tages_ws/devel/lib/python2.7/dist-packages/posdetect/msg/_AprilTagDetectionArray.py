...
"""autogenerated by genpy from posdetect/AprilTagDetectionArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import posdetect.msg
import geometry_msgs.msg
import std_msgs.msg

class AprilTagDetectionArray(genpy.Message):
  _md5sum = "2b6c03434883a5c9897c13b5594dbd91"
  _type = "posdetect/AprilTagDetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','posdetect/AprilTagDetection[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.detections:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%si'%length
        buff.write(struct.pack(pattern, *val1.id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = posdetect.msg.AprilTagDetection()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
        ...
        val1.id = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        val1.size = struct.unpack(pattern, str[start:end])
        _v8 = val1.pose
        _v9 = _v8.header
        start = end
        end += 4
