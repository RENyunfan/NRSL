...
class Transform : public ::google::protobuf::Message {
 public:
  ...
  inline const ::gazebo::msgs::Quaternion& rotation() const;
  inline ::gazebo::msgs::Quaternion* mutable_rotation();
  inline ::gazebo::msgs::Quaternion* release_rotation();
  inline void set_allocated_rotation(::gazebo::msgs::Quaternion* rotation);
...
inline ::gazebo::msgs::Quaternion* Transform::mutable_rotation() {
  set_has_rotation();
  if (rotation_ == NULL) rotation_ = new ::gazebo::msgs::Quaternion;
