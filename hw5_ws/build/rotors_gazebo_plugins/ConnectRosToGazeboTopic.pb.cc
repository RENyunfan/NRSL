...
void protobuf_AssignDesc_ConnectRosToGazeboTopic_2eproto() {
  ...
  ConnectRosToGazeboTopic_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ConnectRosToGazeboTopic, _unknown_fields_),
      -1,
...
ConnectRosToGazeboTopic* ConnectRosToGazeboTopic::New() const {
  return new ConnectRosToGazeboTopic;
}
...
::google::protobuf::uint8* ConnectRosToGazeboTopic::SerializeWithCachedSizesToArray(
...
void ConnectRosToGazeboTopic::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const ConnectRosToGazeboTopic* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const ConnectRosToGazeboTopic*>(
      &from);
  if (source == NULL) {
