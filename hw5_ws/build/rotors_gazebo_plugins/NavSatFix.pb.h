...
class NavSatFix : public ::google::protobuf::Message {
 public:
  NavSatFix();
  virtual ~NavSatFix();
  ...
  static const Service SERVICE_GPS = NavSatFix_Service_SERVICE_GPS;
  static const Service SERVICE_GLONASS = NavSatFix_Service_SERVICE_GLONASS;
  static const Service SERVICE_COMPASS = NavSatFix_Service_SERVICE_COMPASS;
  static const Service SERVICE_GALILEO = NavSatFix_Service_SERVICE_GALILEO;
  ...
  static const Status STATUS_NO_FIX = NavSatFix_Status_STATUS_NO_FIX;
  static const Status STATUS_FIX = NavSatFix_Status_STATUS_FIX;
  static const Status STATUS_SBAS_FIX = NavSatFix_Status_STATUS_SBAS_FIX;
  static const Status STATUS_GBAS_FIX = NavSatFix_Status_STATUS_GBAS_FIX;
  ...
  static const PositionCovarianceType COVARIANCE_TYPE_UNKNOWN = NavSatFix_PositionCovarianceType_COVARIANCE_TYPE_UNKNOWN;
  static const PositionCovarianceType COVARIANCE_TYPE_APPROXIMATED = NavSatFix_PositionCovarianceType_COVARIANCE_TYPE_APPROXIMATED;
  static const PositionCovarianceType COVARIANCE_TYPE_DIAGONAL_KNOWN = NavSatFix_PositionCovarianceType_COVARIANCE_TYPE_DIAGONAL_KNOWN;
  static const PositionCovarianceType COVARIANCE_TYPE_KNOWN = NavSatFix_PositionCovarianceType_COVARIANCE_TYPE_KNOWN;
  ...
  inline ::gz_sensor_msgs::NavSatFix_Service service() const;
  inline void set_service(::gz_sensor_msgs::NavSatFix_Service value);

  // required .gz_sensor_msgs.NavSatFix.Status status = 3;
  inline bool has_status() const;
  inline void clear_status();
  static const int kStatusFieldNumber = 3;
  inline ::gz_sensor_msgs::NavSatFix_Status status() const;
  inline void set_status(::gz_sensor_msgs::NavSatFix_Status value);
  ...
  inline bool has_position_covariance_type() const;
  inline void clear_position_covariance_type();
  static const int kPositionCovarianceTypeFieldNumber = 7;
  inline ::gz_sensor_msgs::NavSatFix_PositionCovarianceType position_covariance_type() const;
  inline void set_position_covariance_type(::gz_sensor_msgs::NavSatFix_PositionCovarianceType value);
