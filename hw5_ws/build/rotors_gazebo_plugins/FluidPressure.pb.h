...
class FluidPressure : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_fluid_pressure() const;
  inline void clear_fluid_pressure();
  static const int kFluidPressureFieldNumber = 2;
  inline double fluid_pressure() const;
  inline void set_fluid_pressure(double value);
