...
void protobuf_AssignDesc_RollPitchYawrateThrust_2eproto() {
  ...
  RollPitchYawrateThrust_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RollPitchYawrateThrust, _unknown_fields_),
      -1,
...
RollPitchYawrateThrust* RollPitchYawrateThrust::New() const {
  return new RollPitchYawrateThrust;
}
...
::google::protobuf::uint8* RollPitchYawrateThrust::SerializeWithCachedSizesToArray(
...
void RollPitchYawrateThrust::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const RollPitchYawrateThrust* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const RollPitchYawrateThrust*>(
      &from);
  if (source == NULL) {
