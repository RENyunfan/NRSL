...
void protobuf_AssignDesc_ConnectGazeboToRosTopic_2eproto() {
  ...
  ConnectGazeboToRosTopic_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ConnectGazeboToRosTopic, _unknown_fields_),
      -1,
...
ConnectGazeboToRosTopic* ConnectGazeboToRosTopic::New() const {
  return new ConnectGazeboToRosTopic;
}
...
::google::protobuf::uint8* ConnectGazeboToRosTopic::SerializeWithCachedSizesToArray(
...
void ConnectGazeboToRosTopic::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const ConnectGazeboToRosTopic* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const ConnectGazeboToRosTopic*>(
      &from);
  if (source == NULL) {
...
void ConnectGazeboToRosTopic::MergeFrom(const ConnectGazeboToRosTopic& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_gazebo_topic()) {
      set_gazebo_topic(from.gazebo_topic());
    }
    if (from.has_ros_topic()) {
      set_ros_topic(from.ros_topic());
    }
    if (from.has_msgtype()) {
...
void ConnectGazeboToRosTopic::Swap(ConnectGazeboToRosTopic* other) {
  if (other != this) {
    std::swap(gazebo_topic_, other->gazebo_topic_);
    std::swap(ros_topic_, other->ros_topic_);
