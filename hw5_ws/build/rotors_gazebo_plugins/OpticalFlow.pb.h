...
class opticalFlow : public ::google::protobuf::Message {
 public:
  ...
  inline float sensor_id() const;
  inline void set_sensor_id(float value);
  ...
  inline float integration_time_us() const;
  inline void set_integration_time_us(float value);
  ...
  inline float time_delta_distance_us() const;
  inline void set_time_delta_distance_us(float value);
