...
enum class AUTOQUAD_NAV_STATUS : int64_t
{
    ...
    AQ_NAV_STATUS_DAO=33554432, /* Dynamic Altitude Override is active (AH with proportional manual adjustment) | */
