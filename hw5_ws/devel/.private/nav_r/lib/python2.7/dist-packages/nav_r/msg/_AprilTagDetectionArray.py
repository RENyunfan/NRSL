...
"""autogenerated by genpy from nav_r/AprilTagDetectionArray.msg. Do not edit."""
import sys
...
class AprilTagDetectionArray(genpy.Message):
  ...
  _type = "nav_r/AprilTagDetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','nav_r/AprilTagDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = nav_r.msg.AprilTagDetection()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
